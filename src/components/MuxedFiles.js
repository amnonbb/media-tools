...
class MuxedFiles extends Component {
    ...
    selectFile = (file) => {
        ...
        let source = `/dl/backup/tmp/muxed/${file}`
        ...
        return (
            <Segment textAlign='center' className="wfdb_app" color='blue' raised>
                ...
                <Segment attached raised textAlign='center'>
                    <Label attached='top' className="files_label">Muxed</Label>
